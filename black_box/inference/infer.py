...
def infer(
        ...
        out_path='/Users/owenmeyer/dsp-modeler/outputs/pred_d-4_f-4_v-6.wav',
        checkpoint = '/Users/owenmeyer/dsp-modeler/black-box/model_final.pt',
    ...
    wavfile.write(out_path, sr, (pred_clipped * (2**31 - 1)).astype(np.int32))
